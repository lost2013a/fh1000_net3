...
void FLASH_Read(uint32_t ReadAddr,int32_t *pBuffer,uint32_t NumToRead);//到指定的flash读取数据
void FLASH_Write(uint32_t WriteAddr,int32_t *pBuffer,uint32_t NumToWrite);//写入数据到指定的地方
